  ...
  return (
    <>
      ...
      <Container>
        ...
        <Typography sx={{ mt: 0, fontSize: "0.8em" }}>
        ...
        <Typography>
          ...
          development, I miss the consistent and reusability. Thus, I create
          this page as an reference of the design of my website.
        </Typography>
        ...
        <Typography>
          ...
          application of the book. The author also designed a families of
          elegant fonts, this website is using{" "}
          <Link href="https://mbtype.com/fonts/triplicate/">Triplicate</Link>{" "}
          font for inline and block code; and{" "}
        ...
        <Typography>
          ...
          <Link href={"https://mui.com/"}>Material UI</Link> for UI/theming, I
          try to take full advantage and utilize the feature of the Material UI
          to achieve the design of this website.
        </Typography>
